                    ...
                    >
                      ...
                      >
                        ...
                        <FormInputGroup
                          ...
                          helpTextWarning="This only works if the user running sonarr is owner of the file. It's better to ensure the download client sets the permissions properly."
                          // helpLink="https://github.com/sonarr/sonarr/wiki#asdf"
                          onChange={onInputChange}
                      ...
                      >
                        ...
                        <FormInputGroup
                          ...
                          helpTextWarning="This only works if the user running sonarr is owner of the file. It's better to ensure the download client uses the same group as sonarr."
                          // helpLink="https://github.com/sonarr/sonarr/wiki#asdf"
                          values={fileDateOptions}
                          onChange={onInputChange}
                          {...settings.chownGroup}
